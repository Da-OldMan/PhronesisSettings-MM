        ...
        switch (p.getClass().getSimpleName()) {
            ...
            case "MyListPreference":
                ...
                if (key.equals("killprocess_signal_style")) {
                    ...
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("QSPanel_NumberCount")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("toggle_buttons_background")) {
                    appRebootRequired("com.android.systemui");
            ...
            case "ColorPickerPreference":
                ...
                if (key.equals("quick_launch_background_color")) {
                    ...
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("statusbar_wifi_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("statusbar_signal_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("statusbar_data_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("toggle_buttons_background")) {
                    appRebootRequired("com.android.systemui");
                    ...
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("toggle_text_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("brightness_background_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("data_usage_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("statusbar_data_color")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("notification_background_color")) {
